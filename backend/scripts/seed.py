        ...
        _activity_log(
            ...
            [
                _violation(
                    "rule-rest-foot",
                    "rest_between_class",
                    "Only 3 days since last foot-load session — rest window not complete",
                    "caution",
                )
            ],
        ),
        ...
        _activity_log(
            ...
            [
                _violation(
                    "rule-rest-foot",
                    "rest_between_class",
                    "Breaks 3-day rest rule for foot load — only 3 days since morning walk",
                    "caution",
                )
            ],
        ),
        ...
        _activity_log(
            ...
            [
                _violation(
                    "rule-rest-foot",
                    "rest_between_class",
                    "Breaks 3-day rest rule for foot load — 2 days since last walk",
                    "caution",
                )
            ],
        ),
        _activity_log(
            ...
            [
                _violation(
                    "rule-rest-foot",
                    "rest_between_class",
                    "Breaks 3-day rest rule for foot load — 1 day since last session",
                    "danger",
                )
            ],
        ),
...
def _daily_check_ins() -> list[DailyCheckIn]:
    return [
        DailyCheckIn(
            id="ci-1",
            user_id=LOCAL_USER_ID,
            check_in_date=_date("2026-04-24"),
            pain_level=7,
            readiness_level=2,
            stiffness_level=8,
            has_flare_up=True,
        ...
        DailyCheckIn(
            id="ci-2",
            user_id=LOCAL_USER_ID,
            check_in_date=_date("2026-04-28"),
            pain_level=4,
            readiness_level=4,
            stiffness_level=5,
            has_flare_up=False,
        ...
        DailyCheckIn(
            id="ci-3",
            user_id=LOCAL_USER_ID,
            check_in_date=_date("2026-05-05"),
            pain_level=2,
            readiness_level=7,
            stiffness_level=3,
            has_flare_up=False,
        ...
        DailyCheckIn(
            id="ci-4",
            user_id=LOCAL_USER_ID,
            check_in_date=_date("2026-05-16"),
            pain_level=8,
            readiness_level=1,
            stiffness_level=9,
            has_flare_up=True,
        ...
        DailyCheckIn(
            id="ci-5",
            user_id=LOCAL_USER_ID,
            check_in_date=_date("2026-05-22"),
            pain_level=2,
            readiness_level=7,
            stiffness_level=3,
            has_flare_up=False,
        ...
        DailyCheckIn(
            id="ci-6",
            user_id=LOCAL_USER_ID,
            check_in_date=_date("2026-05-24"),
            pain_level=1,
            readiness_level=8,
            stiffness_level=2,
            has_flare_up=False,
...
def _flare_up_incidents() -> list[FlareUpIncident]:
    return [
        FlareUpIncident(
            id="inc-1",
            user_id=LOCAL_USER_ID,
            incident_date=_date("2026-04-24"),
            body_part="Left heel",
            severity=6,
            activity_class_id="cls-foot",
        ...
        FlareUpIncident(
            id="inc-2",
            user_id=LOCAL_USER_ID,
            incident_date=_date("2026-05-16"),
            body_part="Left heel",
            severity=8,
            activity_class_id="cls-foot",
