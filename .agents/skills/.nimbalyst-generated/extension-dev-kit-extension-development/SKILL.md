---
name: "extension-dev-kit-extension-development"
...
Use this when the user explicitly invokes `/extension-dev-kit-extension-development` or when the workflow fits implicitly.
